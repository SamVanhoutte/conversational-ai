...
namespace NasdaqBot
{
    ...
    {
        public AdapterWithErrorHandler(IConfiguration configuration, IHttpClientFactory httpClientFactory, ILogger<IBotFrameworkHttpAdapter> logger, MultiLingualMiddleware translationMiddleware, ConversationState conversationState = null)
