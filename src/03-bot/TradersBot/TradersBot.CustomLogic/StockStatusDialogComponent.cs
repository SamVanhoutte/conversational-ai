...
namespace TradersBot.CustomLogic
{
    ...
    public class StockStatusDialogComponent : BotComponent
    {
        public override void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<DeclarativeType>(sp => new DeclarativeType<StockStatusDialog>(StockStatusDialog.Kind));
        }
    }
}