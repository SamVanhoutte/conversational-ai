...
bf dialog:merge "*.schema" "!**/sdk-backup.schema" "*.uischema" "!**/sdk-backup.uischema" "!**/sdk.override.uischema" "!**/generated" "!**/generated/interruption " "../*.csproj" "../package.json" -o $SCHEMA_FILE
